  ...
  return (
    <div className="bg-white rounded-2xl border border-[#D8D5D0] p-5 md:p-6">
      <div className="flex items-center gap-2.5 mb-5">
        ...
        <h2 className="font-heading text-base font-semibold text-[#201F1E]">Site Overview</h2>
      </div>
      ...
      {parsed ? (
        ...
        <p className="text-sm text-[#7A756E]">No coordinates available to display map.</p>
      )}
    </div>
  );
}
