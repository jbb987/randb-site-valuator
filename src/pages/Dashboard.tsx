    ...
    return (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 2.25C10.5 5.25 7.5 8.25 7.5 11.25a4.5 4.5 0 009 0c0-3-3-6-4.5-9z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 18.75c1.5-1.5 3-1.5 4.5 0s3 1.5 4.5 0 3-1.5 4.5 0 3-1.5 4.5 0"
        />
      </svg>
    );
  }
  ...
  if (type === 'hammer') {
    return (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path d="M11.414 10l-7.383 7.418a2.091 2.091 0 0 0 0 2.967 2.11 2.11 0 0 0 2.976 0l7.407 -7.385" />
        ...
        {toolSections.map((section) => {
          ...
          return (
            <section key={section.title}>
              <h2 className="font-heading text-2xl font-semibold text-[#201F1E] mb-6">
                {section.title}
              </h2>
