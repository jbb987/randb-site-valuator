...
const STATE_BOUNDS: StateBounds[] = [
  ...
  { abbr: 'NH', latMin: 42.7, latMax: 45.3, lngMin: -72.56, lngMax: -70.7 },
  ...
  { abbr: 'WV', latMin: 37.2, latMax: 40.64, lngMin: -82.64, lngMax: -77.72 },
  { abbr: 'SC', latMin: 32.03, latMax: 35.21, lngMin: -83.35, lngMax: -78.54 },
  { abbr: 'ME', latMin: 43.06, latMax: 47.46, lngMin: -71.08, lngMax: -66.95 },
  { abbr: 'IN', latMin: 37.77, latMax: 41.76, lngMin: -88.1, lngMax: -84.78 },
  { abbr: 'KY', latMin: 36.5, latMax: 39.15, lngMin: -89.57, lngMax: -81.96 },
  { abbr: 'TN', latMin: 34.98, latMax: 36.68, lngMin: -90.31, lngMax: -81.65 },
  { abbr: 'VA', latMin: 36.54, latMax: 39.47, lngMin: -83.68, lngMax: -75.24 },
  { abbr: 'OH', latMin: 38.4, latMax: 41.98, lngMin: -84.82, lngMax: -80.52 },
  { abbr: 'PA', latMin: 39.72, latMax: 42.27, lngMin: -80.52, lngMax: -74.69 },
  { abbr: 'NY', latMin: 40.5, latMax: 45.01, lngMin: -79.76, lngMax: -71.86 },
  { abbr: 'NC', latMin: 33.84, latMax: 36.59, lngMin: -84.32, lngMax: -75.46 },
  { abbr: 'GA', latMin: 30.36, latMax: 35.0, lngMin: -85.61, lngMax: -80.84 },
  { abbr: 'AL', latMin: 30.22, latMax: 35.01, lngMin: -88.47, lngMax: -84.89 },
  { abbr: 'MS', latMin: 30.17, latMax: 34.99, lngMin: -91.66, lngMax: -88.1 },
  { abbr: 'LA', latMin: 28.93, latMax: 33.02, lngMin: -94.04, lngMax: -88.82 },
  { abbr: 'AR', latMin: 33.0, latMax: 36.5, lngMin: -94.62, lngMax: -89.64 },
  { abbr: 'FL', latMin: 24.52, latMax: 31.0, lngMin: -87.63, lngMax: -80.03 },
  { abbr: 'MI', latMin: 41.7, latMax: 48.26, lngMin: -90.42, lngMax: -82.42 },
  { abbr: 'WI', latMin: 42.49, latMax: 47.08, lngMin: -92.89, lngMax: -86.25 },
  { abbr: 'IL', latMin: 36.97, latMax: 42.51, lngMin: -91.51, lngMax: -87.02 },
  { abbr: 'IA', latMin: 40.37, latMax: 43.5, lngMin: -96.64, lngMax: -90.14 },
  { abbr: 'MO', latMin: 35.99, latMax: 40.61, lngMin: -95.77, lngMax: -89.1 },
  { abbr: 'MN', latMin: 43.5, latMax: 49.38, lngMin: -97.24, lngMax: -89.49 },
  { abbr: 'OK', latMin: 33.84, latMax: 37.0, lngMin: -103.0, lngMax: -94.43 },
  { abbr: 'KS', latMin: 37.0, latMax: 40.0, lngMin: -102.05, lngMax: -94.59 },
  { abbr: 'NE', latMin: 40.0, latMax: 43.0, lngMin: -104.05, lngMax: -95.31 },
  { abbr: 'SD', latMin: 42.48, latMax: 45.94, lngMin: -104.06, lngMax: -96.44 },
  { abbr: 'ND', latMin: 45.94, latMax: 49.0, lngMin: -104.05, lngMax: -96.55 },
  // Large western states
  { abbr: 'TX', latMin: 25.84, latMax: 36.5, lngMin: -106.65, lngMax: -93.51 },
  { abbr: 'NM', latMin: 31.33, latMax: 37.0, lngMin: -109.05, lngMax: -103.0 },
  { abbr: 'CO', latMin: 37.0, latMax: 41.0, lngMin: -109.06, lngMax: -102.04 },
  { abbr: 'WY', latMin: 41.0, latMax: 45.0, lngMin: -111.06, lngMax: -104.05 },
  { abbr: 'MT', latMin: 44.36, latMax: 49.0, lngMin: -116.05, lngMax: -104.04 },
  { abbr: 'AZ', latMin: 31.33, latMax: 37.0, lngMin: -114.82, lngMax: -109.04 },
  { abbr: 'UT', latMin: 37.0, latMax: 42.0, lngMin: -114.05, lngMax: -109.04 },
  { abbr: 'NV', latMin: 35.0, latMax: 42.0, lngMin: -120.01, lngMax: -114.04 },
  { abbr: 'ID', latMin: 42.0, latMax: 49.0, lngMin: -117.24, lngMax: -111.04 },
  ...
  { abbr: 'WA', latMin: 45.54, latMax: 49.0, lngMin: -124.85, lngMax: -116.92 },
