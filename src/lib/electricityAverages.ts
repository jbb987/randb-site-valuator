...
export const STATE_ELECTRICITY_AVERAGES: Record<string, ElectricityAverage> = {
  ...
  CA: { commercial: 24.7, industrial: 19.66, allSectors: 27.27 },
  CO: { commercial: 12.19, industrial: 9.1, allSectors: 13.08 },
  CT: { commercial: 21.6, industrial: 18.42, allSectors: 25.4 },
  ...
  IL: { commercial: 11.3, industrial: 8.49, allSectors: 13.27 },
  IN: { commercial: 13.12, industrial: 8.76, allSectors: 12.77 },
  IA: { commercial: 13.74, industrial: 7.63, allSectors: 12.6 },
  KS: { commercial: 12.79, industrial: 9.1, allSectors: 13.15 },
  KY: { commercial: 11.06, industrial: 6.63, allSectors: 10.33 },
  LA: { commercial: 10.71, industrial: 6.4, allSectors: 10.14 },
  ...
  NV: { commercial: 10.45, industrial: 7.18, allSectors: 11.3 },
  NH: { commercial: 19.7, industrial: 16.46, allSectors: 22.57 },
  ...
  OH: { commercial: 11.82, industrial: 7.9, allSectors: 12.52 },
  ...
  SC: { commercial: 11.63, industrial: 6.99, allSectors: 11.9 },
  ...
  DC: { commercial: 14.44, industrial: 12.1, allSectors: 14.55 },
};
